...
Resources: [GitHub](https://github.com/), [GitHub Education](https://github.com/education), [Git](https://git-scm.com/downloads), [CodeSinaia-2026](https://github.com/inproted/CodeSinaia-2026)
...
- [ ] In the command window create a folder where you intend to store your code and clone the [_CodeSinaia-2026_](https://github.com/inproted/CodeSinaia-2026) repository via these steps:
```
    ...
    C:\Users\Florin\git>git clone https://github.com/C-FlorinTeo/CodeSinaia-2026.git
...
```
    C:\Users\Florin\git>cd CodeSinaia-2026

    C:\Users\Florin\git\CodeSinaia-2026>git pull
    Already up to date.

    C:\Users\Florin\git\CodeSinaia-2026>
```
